...
const Reports = () => {
  return (
    <section className="pr flex-row">
      <div className="dsl pr_sec">
        <div>
          <h3>Introduction</h3>
          This page is used to inform website visitors regarding our policies
          with the collection, use, and disclosure of Personal Information if
          anyone decided to use our Service, the Ayodelejayne website. If you
          ...
          of the Privacy Policy Template and the Privacy Policy Generator. The
          terms used in this Privacy Policy have the same meanings as in our
          Terms and Conditions, which is accessible at app.Ayodelejayne.io,
        ...
        <div>
          ...
          <p>
            ...
            do not hesitate to{' '}
            <a href="mailTo: ayoadetimehin@gmail.com">Contact Us</a>.
          </p>
        </div>
      </div>
    </section>
